...
env_arg.add_argument('--num_descriptors', type=int, default=100, help='number of unique packets')
env_arg.add_argument('--file_size', type=int,default=100000, help='size of each file')
...
data_arg.add_argument('--min_length', type=int, default=100, help='minimum chain length')
data_arg.add_argument('--max_length', type=int, default=100, help='maximum chain length')

# Training / test parameters
train_arg = add_argument_group('Training')
train_arg.add_argument('--num_epoch', type=int, default=50000, help='number of epochs')
