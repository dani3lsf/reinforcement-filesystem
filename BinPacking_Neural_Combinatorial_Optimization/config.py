...
data_arg.add_argument('--min_length', type=int, default=8, help='minimum chain length')
data_arg.add_argument('--max_length', type=int, default=8, help='maximum chain length')
